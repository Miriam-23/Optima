...
class DashboardService:
    ...
    def obtener_metricas_proyecto(proyecto) -> dict:
        ...
        Usado tanto por la API del dashboard como por el chatbot.
        """
        ...
        for miembro in miembros:
            tareas_miembro = tareas.filter(responsables__usuario=miembro.usuario)
            total_miembro = tareas_miembro.count()
            completadas_miembro = tareas_miembro.filter(estado__nombre='Hecho').count()
