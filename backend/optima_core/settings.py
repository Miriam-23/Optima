...
INSTALLED_APPS = [
    ...
    'corsheaders',
    # Aplicaciones del proyecto "Optima"
    'users',
    'projects',
    'tasks',
    'notifications'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=8),   # El token dura una jornada laboral
...
WSGI_APPLICATION = 'optima_core.wsgi.application'
